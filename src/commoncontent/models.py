...
class SiteVar(models.Model):
    ...
    ``commoncontent.apps.context_defaults``. You can store any variables for your own
    ...
    - ``custom_stylesheet`` - A site-specific CSS file. This is pulled into the
      ``extra_head`` block after bootstrap and commoncontent's CSS, so you can use it to
